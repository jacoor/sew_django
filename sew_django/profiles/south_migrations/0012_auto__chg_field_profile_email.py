...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'profiles_profile', 'email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Profile.email'
        db.alter_column(u'profiles_profile', 'email', self.gf('django.db.models.fields.EmailField')(max_length=110, unique=True))
