...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.is_superuser'
        db.add_column(u'profiles_profile', 'is_superuser',
    ...
    def backwards(self, orm):
        # Deleting field 'Profile.is_superuser'
        db.delete_column(u'profiles_profile', 'is_superuser')
