...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'profiles_profile', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Profile.last_name'
        db.alter_column(u'profiles_profile', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=30))
