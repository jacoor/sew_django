...
class Profile(AbstractBaseUser, PermissionsMixin):
    ...
    consent_processing_of_personal_data = models.BooleanField(
        (u"Wyrażam zgodę na przetwarzanie podanych danych"
            + u" osobowych przez Stowarzyszenie Hobbystów Kolejowych z siedzibą w Warszawie przy ul. Orląt"
            + u" Lwowskich 38, stosownie do postanowień Ustawy z dnia 29 sierpnia 1997 r. o ochronie danych osobowych"
            + u" (Dz. U. nr 133, poz. 883 ze zm.) w celu organizacji {settings.FINALE_NR} Finału Wielkiej Orkiestry"
            + u" Świątecznej Pomocy we Wrocławiu. Oświadczam, że zostałem poinformowany, że podanie moich danych"
            + u" osobowych ma charakter dobrowolny oraz, że przysługuje mi prawo wglądu do nich, jak również możliwość"
    ...
    accept_of_sending_data_to_WOSP = models.BooleanField(
        u"Wyrażam zgodę na przekazanie moich danych do fundacji"
